...
import { bodyDeleteRelationshipMixin } from './body-delete-relationship';
...
describe('BodyDeleteRelationship', () => {
  ...
  const pipeMixin = bodyDeleteRelationshipMixin(entityMock, mockConnectionName);
