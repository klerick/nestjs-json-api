...
export function bodyPostRelationshipMixin(entity: Entity, connectionName: string): PipeTransformMixin {
  @Injectable()
  class BodyPostRelationshipMixin implements PipeTransform {
  ...
  return mixin(BodyPostRelationshipMixin);
}
