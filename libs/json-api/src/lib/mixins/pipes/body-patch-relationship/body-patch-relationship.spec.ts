...
import { bodyPatchRelationshipMixin } from './body-patch-relationship';
...
describe('BodyPatchRelationship', () => {
  ...
  const pipeMixin = bodyPatchRelationshipMixin(entityMock, mockConnectionName);
