...
import {JSON_API_DECORATOR_ENTITY, JSON_API_DECORATOR_OPTIONS} from '../../constants/reflection';
...
describe('InjectServiceDecorator', () => {
  ...
  it('should save options in class using helpFunction', () => {
    ...
    const data: DecoratorOptions = Reflect.getMetadata(JSON_API_DECORATOR_OPTIONS, SomeClass);
    expect(data).toEqual(apiOptions);
