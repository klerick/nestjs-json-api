...
import {CONFIG_PARAM_POSTFIX, TYPEORM_MIXIN_SERVICE_POSTFIX} from '../../../constants';

export function typeormMixin<Entity extends EntityClassOrSchema>(entity: Entity, connectionName: string, transformService: NestProvider): NestProvider {
  const serviceClass = nameIt(getProviderName(entity, TYPEORM_MIXIN_SERVICE_POSTFIX), TypeormMixinService);
