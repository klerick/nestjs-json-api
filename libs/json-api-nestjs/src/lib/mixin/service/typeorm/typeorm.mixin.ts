...
export class TypeormMixinService<Entity>
  implements JsonApiServiceMethode<Entity>
{
  ...
  getAll(
    this: TypeormMixinService<Entity>,
    options: ServiceOptions<Entity>
  ...
  getRelationship(
    options: ServiceOptions<Entity>
  ): Promise<{ meta?: Partial<Meta> } & Relationship<Entity>> {
