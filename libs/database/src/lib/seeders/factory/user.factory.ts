import {FactorizedAttrs, Factory, CollectionSubfactory, SingleSubfactory} from '@jorgebodega/typeorm-factory';
...
export class UserFactory extends Factory<Users> {
  ...
  const lastName = faker.name.lastName(gender);
    ...
    return {
      ...
      firstName: firstName,
      lastName: lastName,
      comments: new CollectionSubfactory(new CommentsFactory(this.dataSource), faker.datatype.number(10)),
